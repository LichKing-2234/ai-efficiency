...
var (
	...
	AttributionClaimGroupsColumns = []*schema.Column{
		...
		{Name: "checkpoint_id", Type: field.TypeInt},
		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  false,
				Columns: []*schema.Column{AttributionClaimGroupsColumns[3], AttributionClaimGroupsColumns[8], AttributionClaimGroupsColumns[14]},
			},
			{
				Name:    "attributionclaimgroup_installation_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{AttributionClaimGroupsColumns[2], AttributionClaimGroupsColumns[15]},
			},
		},
	}

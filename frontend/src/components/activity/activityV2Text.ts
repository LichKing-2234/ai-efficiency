...
const messages = {
  'en-US': {
    unitToken: 'Token', unitCredit: 'Credit', unitSwitchLabel: 'Usage unit', noCommittedCreditData: 'No Credit linked to committed code this period.', noCreditRepositories: 'No repositories with committed Credit.',
    codeCreditRatio: 'Credit used for actual code', codeCreditRatioHelp: 'Share of this period’s AI Credit linked to committed code.',
    otherCredit: 'Other Credit',
    unitSourceHelp: 'Token usage comes from the gateway’s billing records; Credit usage is self-reported by the agent.',
    otherCreditHelp: 'Other Credit is remaining AI usage, not necessarily non-development work.',
    committedCredit: 'Committed Credit', involvedCredit: 'Involved Credit', sharedCreditParticipation: 'Shared participation',
    creditTrend: 'Committed Credit trend', noCreditUsage: 'No AI Credit this period', sortCredit: 'Credit descending',
    committedShare: 'of committed usage',
  ...
  'zh-CN': {
    unitToken: 'Token', unitCredit: 'Credit', unitSwitchLabel: '用量单位', noCommittedCreditData: '本周期没有关联到提交代码的 Credit。', noCreditRepositories: '本周期没有产生提交代码 Credit 的 Repository。',
    codeCreditRatio: '用于实际代码的 Credit', codeCreditRatioHelp: '本周期全部 AI Credit 中，已关联到提交代码的比例。',
    otherCredit: '其他 Credit',
    unitSourceHelp: 'Token 用量来自网关计费记录，Credit 用量由 Kiro 自行上报。',
    otherCreditHelp: '其他 Credit 是本周期剩余的 AI 使用量，并不代表这些 Credit 没有用于开发。',
    committedCredit: '提交代码 Credit', involvedCredit: '涉及 Credit', sharedCreditParticipation: '共享参与 Credit',
    creditTrend: '提交代码 Credit 趋势', noCreditUsage: '本周期没有 AI Credit 使用', sortCredit: 'Credit 从高到低',
    committedShare: '提交代码占比',

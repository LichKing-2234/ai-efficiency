...
func newTeamUsageService(entClient *ent.Client, sqlDB *sql.DB, providerHandler *ProviderHandler, scopeCache *representativescope.Cache, snapshotCache *teamusage.SnapshotCache, originCache *teamusage.OriginCache, memberCursorSecret string) (*teamusage.Service, error) {
	...
	return teamusage.NewService(
		...
		teamusage.ServiceOptions{SnapshotCache: snapshotCache, OriginCache: originCache, CursorSecret: memberCursorSecret},
	)
}

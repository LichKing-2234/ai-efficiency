...
function SheetHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex flex-col gap-1 px-[18px] pt-[18px] pb-0", className)}
      {...props}
    />
  )
}
...
function SheetFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("mt-auto flex flex-col gap-2 px-[18px] pt-0 pb-[18px]", className)}
      {...props}
    />
  )
}
...
function SheetTitle({
  ...
  return (
    <SheetPrimitive.Title
      ...
      className={cn(
        "font-[650] text-[14px] text-foreground",
        className
      )}
      {...props}
    />
...
function SheetDescription({
  ...
  return (
    <SheetPrimitive.Description
      ...
      className={cn("text-[12px] text-[var(--ink-3)]", className)}
      {...props}
    />
  )
}

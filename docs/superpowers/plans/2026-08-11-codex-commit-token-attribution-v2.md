...
- [x] Publish the repair as PR #325 from implementation commit `37bce887` and
  verify hosted CI run `32359234453` passes backend, frontend, ae-cli, and
  deploy-static.

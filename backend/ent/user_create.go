...
func (uc *UserCreate) SetAuthSource(us user.AuthSource) *UserCreate {
	uc.mutation.SetAuthSource(us)
	return uc
}

// SetRelayUserID sets the "relay_user_id" field.
func (uc *UserCreate) SetRelayUserID(i int) *UserCreate {
	uc.mutation.SetRelayUserID(i)
	return uc
}

// SetNillableRelayUserID sets the "relay_user_id" field if the given value is not nil.
func (uc *UserCreate) SetNillableRelayUserID(i *int) *UserCreate {
	if i != nil {
		uc.SetRelayUserID(*i)
	}
	return uc
...
func (uc *UserCreate) SetNillableLdapDn(s *string) *UserCreate {
	if s != nil {
		uc.SetLdapDn(*s)
	}
	return uc
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.AuthSource(); ok {

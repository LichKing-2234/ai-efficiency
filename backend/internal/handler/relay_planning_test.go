...
func TestRelayPlanningReplanIncludesSavedExternalMember(t *testing.T) {
	...
	mapping := client.RelayGroupMapping.Create().
		...
		SetMemberAssignments(map[string]int64{fmt.Sprint(bob.ID): 101}).SetMemberSources(map[string]int64{fmt.Sprint(bob.ID): 30}).
	...
	provider := &relayPlanningSearchProvider{
		...
		keys:              map[int64][]relay.APIKey{42: {}, 43: {{ID: 501, UserID: 43, GroupID: 101, Status: "active"}, {ID: 502, UserID: 43, GroupID: 101, Status: "inactive"}}, 44: {}, 45: {}},

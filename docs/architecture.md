...
groups use trusted Request/turn evidence and Relay-official Token. The pending
WebSocket extension uses trusted transport/turn evidence plus aggregated Codex

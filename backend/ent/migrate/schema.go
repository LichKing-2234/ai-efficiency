...
var (
	...
	QuotaResetRequestsColumns = []*schema.Column{
		...
		{Name: "requester_department_paths", Type: field.TypeJSON},
		{Name: "requester_notification_ids", Type: field.TypeJSON},
		...
		{Name: "resolved_approver_user_ids", Type: field.TypeJSON},
		{Name: "matched_department_paths", Type: field.TypeJSON},

...
- Relay/sub2api remains the upstream auth/LLM/usage integration boundary, admin subscription assignment boundary, and attribution fallback source.
...
| Relay integration | `backend/internal/relay` | Unified relay/sub2api adapter, subscription assignment, and usage/API key operations |
